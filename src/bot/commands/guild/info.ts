...
const infoCommand: Command = {
	name: 'info',
	description: 'Invia informazioni su Vaiolowser',
	...
	async run(message: Message) {
		...
		const embed = new EmbedBuilder()
			.setColor('#0099ff')
			.setTitle('Informazioni su Vaiolowser')
			.addFields([
				{ name: 'Nome', value: 'Malario' },
				{ name: 'Versione', value: version },
				{ name: 'Git Hash', value: gitHash },
				{ name: 'Autore', value: 'Spartacus04 | Sistone' },
				{ name: 'Descrizione', value: 'Vaiolowser è un bot discord che ti aiuta a gestire il tuo server' },
